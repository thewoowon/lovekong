...
export const mainComment: MainCommentItemType[] = [
  ...
  },
  {
    ...
    color: '2 오로라',
    comment:
      '그냥 둬도 예쁘지만 초 켜니 진짜 진짜 x100 예뻐요!! 홈카페나 밤에 와인 마실때 켜면 분위기 깡패예요. 유리에서 퍼져나가는 빛이 너무 우아하고 고급져요!',
  ...
  },
  {
    ...
    size: '미디움',
    color: '2 다이아',
    comment: '좋아요! 빛이 예쁘고, 무게감도 있어서 좋아요.',
    createdAt: '2021-10-14',
    rate: 5,
    user_img:
  ...
  },
  {
    ...
    color: '2 샴페인',
    comment:
      '예쁘고 귀여워요! 샴페인은 뭔가 더 예쁜거 같아요! 다이아도 이쁘지만 제 취향은 샴페인이네요 😆 러브콩 후회 없을실 거에요.',
    createdAt: '2021-10-14',
    rate: 5,
    user_img:
  ...
  },
  {
    ...
    color: '2 오로라',
    comment:
      '구매한거 1도 후회없고 너무 예쁘다고 생각해요. 집에 도착하자마자 켜서 놓고 있어요. 미니 캔들이랑 너무 잘어울리고 무드가 살아나요.',
    createdAt: '2021-10-14',
    rate: 5,
    user_img:
